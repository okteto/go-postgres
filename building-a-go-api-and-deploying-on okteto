...
In this tutorial, we built a CRUD API in Golang directly on Okteto using the Okteto development environment. We also deployed the application to Okteto. 
